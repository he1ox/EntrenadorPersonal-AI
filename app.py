...
webcam_video = gr.Video(source="webcam", label="Input Video")
...
output_video_file_cam = gr.Video(label="Analisis: Video")

upload_interface = gr.Interface(
                    fn=process_video,
                    inputs=[input_video, gr.Radio(choices=["Principiante", "Pro"], label="Selecciona un modo",info="Selecciona un modo")],
...
webcam_interface = gr.Interface(
                    ...
                    title=f"TigerAI - Entrenador Personal",
                    allow_flagging="never"
                )  
